...
public final class hobbies_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <i class=\"fas fa-icons\" style=\"font-size:36px\"></i>\n");
      out.write("\n");
      out.write("                        <h3>Hobbies/Interests</h3>\n");
      out.write("                        <p>Tell about your hobbies and interests.</p>\n");
      ...
      out.write("    <button class=\"btnRegister\" onclick=\"goBack()\"><i class='fas fa-pen' style='font-size:24px'></i>&nbsp;&nbsp;<b>Languages</b></button><br/>\n");
      out.write("    <button class=\"btnRegister high\" href=\"\"><i class='fas fa-icons' style='font-size:24px'></i>&nbsp;&nbsp;<b>Hobbies & Interests</b> </button><br/>\n");
      out.write("  \n");
      out.write("  \n");
      out.write("</div>\n");
      out.write("                    </div>\n");
      ...
      out.write("     <input type=\"button\" id=\"btnd\" value=\"Add Hobby\" class=\"btnRegister\" /><br/><br/><br/><br/>\n");
      out.write("       \n");
      out.write("    </div>\n");
      out.write("    <br/><br/>\n");
      out.write("    <input type=\"submit\" name=\"btn_submit\" value=\"Save\" id=\"btnss\" class=\"btnRegister\" />\n");
      out.write("  \n");
      out.write("                                    </div>\n");
      out.write("                                    \n");
      out.write("                                </div>\n");
      ...
      out.write("            if (iCnt <= 19) {\n");
      out.write("\n");
      out.write("                iCnt = iCnt + 1;\n");
      out.write("$(container).append('<div><br/><br/><br/><br/><label>Hobby/Interest:  </label>\\\n");
      out.write("<input class=\"form-control\" type=text name=tb' + iCnt+ ' ' + ' placeholder=\"\" autocomplete=\"off\" tabindex=\"1\">\\\n");
      out.write("<input type=\"button\" class=\"btnReg btnRemove\" value=\"Remove\"><br/><br/></div>'); // end append\n");
      out.write("            $('#btnss').show();\n");
      out.write("\t\t\t\t\t$('div .btnRemove').click (function () { \n");
      ...
      out.write("\t\t\t\t\t});\n");
      out.write("                \n");
      out.write("                $('#main').after(container);\n");
      out.write("            }\n");
      out.write("            else {      \n");
      out.write("                $(container).append('<label id=\"lbl\">Reached the limit! You can add only 8 hobbies.</label>'); \n");
      out.write("                $('#btAnd').attr('disabled', 'disabled');\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("\n");
      out.write("        \n");
    ...
    try{
        ...
        if(request.getParameter("btn_submit")!=null)
        {
            ...
            while(i!=0)
            {
                pst = conn.prepareStatement(" insert into UINTEREST values (?,?) ");
                String hob=request.getParameter("tb"+i);
                i++;
                pst.setString(1, nm);
                pst.setString(2, hob);
                if(hob==null)
