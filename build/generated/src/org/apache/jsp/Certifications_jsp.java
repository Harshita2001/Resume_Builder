...
public final class Certifications_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <i class=\"fas fa-award\" style=\"font-size:36px\"></i>\n");
      out.write("\n");
      out.write("                        <h3>Certifications</h3>\n");
      out.write("                        <p>Tell about your achievements.</p>\n");
      ...
      out.write("    <button class=\"btnRegister\"><i class='fas fa-laptop-code' style='font-size:24px'></i>\n");
      ...
      out.write("    <a class=\"btnRegister high\" href=\"\"><i class='fas fa-award' style='font-size:24px'></i>\n");
      out.write("        &nbsp;&nbsp;<b>Certifications</b> </a><br/>\n");
      ...
      out.write("        <input type=\"button\" id=\"btCE\" value=\"Add Element\" class=\"btnRegister\" /><br/><br/><br/><br/>\n");
      out.write("       \n");
      out.write("    </div>                            \n");
      out.write("                                        \n");
      ...
      out.write("$('#btCE').click(function() {\n");
      out.write("            if (iCnt <= 8) {iCnt = iCnt + 1;\n");
      out.write("$(container).append('<div><br/><br/><br/><label>Certificate Title: </label><input class=\"form-control\" type=text name=tit' + iCnt+ ' ' + ' id=tit' + iCnt + ' ' +' placeholder=\"\" autocomplete=\"off\" tabindex=\"1\"> \\n\\\n");
      out.write("<br/><label>Certificate Description: </label><textarea class=\"form-control\" rows=\"5\" cols=\"50\" name=des' + iCnt+ ' ' + ' id=des' + iCnt + ' ' +' placeholder=\"\" ></textarea><input type=\"button\" class=\"btnC btnReg\" value=\"Remove\"><br/><br/></div>'); // end append\n");
      out.write("            $(\"#anubhi\").show();\n");
      out.write("\t\t\t\t\t$('div .btnC').click (function () { \n");
      out.write("\t\t\t\t\t\t$(this).parent().last().remove(); \n");
      out.write("                                                 $('#lbl').remove();\n");
      out.write("                                                iCnt = iCnt - 1;\n");
      out.write("                                                $('#btC').removeAttr('disabled');\n");
      out.write("                                               \n");
      out.write("                    });\n");
      out.write("                $('#mainC').after(container);\n");
      out.write("            }\n");
      out.write("            else {   \n");
      out.write("                \n");
      out.write("                $(container).append('<label id=\"lbl\">Reached the limit! You can add only 8 Certifications.</label>');  \n");
      out.write("                $('#btCE').attr('disabled', 'disabled');\n");
      out.write("            }\n");
      out.write("        });});\n");
      out.write("</script>\n");
      out.write("<script>\n");
    ...
    try{
        ...
        if(request.getParameter("btn_submit")!=null)
        {
            ...
            while(i!=0)
            {
                ...
                String cert=request.getParameter("tit"+i);
                String des=request.getParameter("des"+i);
                i++;
                pst.setString(1, nm);
