...
public final class language_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <i class=fas fa-pen\" style=\"font-size:36px\"></i>\n");
      out.write("\n");
      out.write("                        <h3>Language</h3>\n");
      out.write("                        <p>Tell about the languages you know.</p>\n");
      ...
      out.write("    <button class=\"btnRegister high\" onclick=\"\"><i class='fas fa-pen' style='font-size:24px'></i>&nbsp;&nbsp;<b>Languages</b></button><br/>\n");
      ...
      out.write("                                      \n");
      out.write("       \n");
      out.write(" <div id=\"mainL\">\n");
      out.write("     <input type=\"button\" id=\"btl\" value=\"Add language\" class=\"btnRegister\" /><br/><br/><br/><br/>\n");
      out.write("       \n");
      out.write("    </div>\n");
      out.write("    <br/><br/>\n");
      out.write("    <input type=\"submit\" name=\"btn_sub\" value=\"Save\" id=\"btnss\" class=\"btnRegister\" />\n");
      out.write("  \n");
      out.write("                                    </div>\n");
      out.write("                                    \n");
      out.write("                                </div>\n");
      ...
      out.write("$('#btl').click(function() {\n");
      out.write("            if (iCnt <= 8) {\n");
      out.write("                iCnt = iCnt + 1;\n");
      out.write("$(container).append('<div><br/><br/><br/><label>Language: </label><input class=\"form-control\" type=text name=ll' + iCnt+ ' ' + ' id=ll' + iCnt + ' ' +' placeholder=\"\" >\\\n");
      out.write("<input type=\"button\" class=\"btnRemo btnReg\" value=\"Remove\"><br><br></div>'); // end append\n");
      out.write("\t $(\"#btnss\").show();\t\t\t\t\n");
      out.write("            $('div .btnRemo').click (function () { \n");
      ...
      out.write("                                                                        }\n");
      out.write("                    });\n");
      out.write("                $('#mainL').after(container);\n");
      out.write("            }\n");
      out.write("            else {   \n");
      out.write("                \n");
      out.write("                $(container).append('<label id=\"lbl\">Reached the limit! you can add only 8 languages.</label>');  \n");
      out.write("                $('#btl').attr('disabled', 'disabled');\n");
      out.write("            }\n");
      out.write("        });});\n");
      out.write("</script>            \n");
      out.write("              \n");
    ...
    try{
        ...
        if(request.getParameter("btn_sub")!=null)
        {
            ...
            while(i!=0)
            {
                ...
                String lang=request.getParameter("ll"+i);
                i++;
                pst.setString(1, nm);
