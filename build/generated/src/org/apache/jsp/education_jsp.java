...
public final class education_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <i class=\"fas fa-graduation-cap\" style=\"font-size:36px\"></i>\n");
      out.write("\n");
      out.write("                        <h3>Education</h3>\n");
      out.write("                        <p>Where did you study?</p>\n");
      out.write("                        <div class=\"tab\">\n");
      out.write("    <button class=\"btnRegister\" onclick=\"goBack()\"><i class=\"material-icons\" style='font-size:24px'>group</i><b>&nbsp;&nbsp;Basic Information</b></button>\n");
      out.write("    <button class=\"btnRegister high\" href=\"\"><i class='fas fa-graduation-cap' style='font-size:24px'></i>\n");
      ...
      out.write("        <input type=\"button\" id=\"btedu\" value=\"Add Education\" class=\"btnRegister\" /><br/><br/><br/>\n");
      out.write("       \n");
      out.write("    </div>\n");
      out.write("                                      \n");
      out.write("                                        \n");
      out.write("                                <br/><br/><br/><br/><br/>        <br/>\n");
      out.write("<input type=\"submit\" class=\"btnRegister\" name=\"btn_submit\" id=\"anubhi\" value=\"Next\"/>\n");
      out.write("\n");
      out.write("                                    </div>\n");
      out.write("                                    \n");
      out.write("                                </div>\n");
      ...
      out.write("                           \n");
      out.write("                        </div></form>\n");
      out.write("<button class=\"btnRegister\" onclick=\"goBack()\"><b>Previous</b></button>\n");
      out.write("    \n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("\n");
      ...
      out.write("$('#btedu').click(function() {\n");
      out.write("    \n");
      out.write("            if (iCnt <= 8) {iCnt = iCnt + 1;\n");
      out.write("$(container).append('<div><br/><br/><br/><br/><label>Program: </label>&nbsp;&nbsp;&nbsp;&nbsp;<input type=text class=\"form-control\" name=ed' + iCnt+ ' ' + ' id=ed' + iCnt + ' ' +' placeholder=\"Program\" autocomplete=\"off\" tabindex=\"1\"> \\n\\\n");
      out.write("<br/><label>Institute: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text class=\"form-control\" name=inst' + iCnt+ ' ' + ' id=inst' + iCnt + ' ' +' placeholder=\"Institute\" autocomplete=\"off\" tabindex=\"1\">\\n\\\n");
      out.write("<br/><label>Start Date: </label>&nbsp;&nbsp;&nbsp;<input type=text class=\"form-control\" name=std' + iCnt+ ' ' + ' id=std' + iCnt + ' ' +' placeholder=\"Start Date\" autocomplete=\"off\" tabindex=\"1\">\\n\\\n");
      out.write("<br/><label>End Date: </label>&nbsp;&nbsp;&nbsp;&nbsp;<input type=text class=\"form-control\" name=end' + iCnt+ ' ' + ' id=end' + iCnt + ' ' +' placeholder=\"End Date\" autocomplete=\"off\" tabindex=\"1\">\\n\\\n");
      out.write("<br/><label>CGPA / Marks: </label>&nbsp;&nbsp;<input type=text class=\"form-control\" name=cgp' + iCnt+ ' ' + ' id=cgp' + iCnt + ' ' +' placeholder=\"CGPA\" autocomplete=\"off\" tabindex=\"1\">  \\n\\\n");
      out.write("<input type=\"button\" class=\"btnE btnReg\" value=\"Remove\"><br/><br/></div>'); // end append\n");
      out.write("            $(\"#anubhi\").show();\n");
      out.write("\t\t\t\t\t$('div .btnE').click (function () { \n");
      out.write("\t\t\t\t\t\t$(this).parent().remove();\n");
      out.write("                                                $('label').remove();\n");
      out.write("                                                iCnt = iCnt - 1;\n");
      out.write("                                                $('#btedu').removeAttr('disabled');\n");
      out.write("                                                if(iCnt===0){\n");
      out.write("            $(\"#anubhi\").hide();\n");
      out.write("        }\n");
      out.write("                    });\n");
      out.write("                $('#mainE').after(container);\n");
      out.write("            }\n");
      out.write("            else {   \n");
      out.write("                \n");
      out.write("                $(container).append('<label>Reached the limit! you can only 8 education.</label>');  \n");
      out.write("                $('#btedu').attr('disabled', 'disabled');\n");
      out.write("            }\n");
      out.write("        });});\n");
      out.write("</script> \n");
      out.write("<script>\n");
    ...
    try{
        ...
        if(request.getParameter("btn_submit")!=null)
        {
            ...
            while(i!=0)
            {
                ...
                String pro=request.getParameter("ed"+i);
                String inst=request.getParameter("inst"+i);
                String st=request.getParameter("std"+i);
                String end=request.getParameter("end"+i);
                String cgpa=request.getParameter("cgp"+i);
                i++;
                pst.setString(1, nm);
                pst.setString(2, pro);
