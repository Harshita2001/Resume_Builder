...
public final class projects_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <i class=\"fas fa-database\" style=\"font-size:36px\"></i>\n");
      out.write("\n");
      out.write("                        <h3>Projects</h3>\n");
      out.write("                        <p>WTell about your projects?</p>\n");
      ...
      out.write("    <button class=\"btnRegister high\" href=\"\"><i class='fas fa-database' style='font-size:24px'></i>&nbsp;&nbsp;<b>Projects</b></button><br/>\n");
      ...
      out.write("        <input type=\"button\" id=\"btPR\" value=\"Add Project\" class=\"btnRegister\" /><br/><br/><br/><br/>\n");
      out.write("       \n");
      out.write("    </div>                            \n");
      out.write("                                        \n");
      out.write("                                <br/><br/>       <br/>\n");
      out.write("<input type=\"submit\" class=\"btnRegister\" name=\"btn_submit\" id=\"anubhi\" value=\"Save\"/>\n");
      out.write("                                    </div>\n");
      out.write("                                    \n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      ...
      out.write("$('#btPR').click(function() {\n");
      out.write("            if (iCnt <= 8) {iCnt = iCnt + 1;\n");
      out.write("$(container).append('<div><br/><br/><br/><br/><label>Project Title: </label>\\n\\\n");
      out.write("<input type=text class=\"form-control\" name=pr' + iCnt+ ' ' + ' id=pr' + iCnt + ' ' +' placeholder=\"Program\" autocomplete=\"off\" tabindex=\"1\"> \\n\\\n");
      out.write("<br/><label>Project Description: </label>\\n\\\n");
      out.write("<textarea class=\"form-control\" rows=\"4\" cols=\"50\" name=pro' + iCnt+ ' ' + ' id=pro' + iCnt + ' ' +' placeholder=\"\"></textarea>\\n\\\n");
      out.write("<br/>\\n\\\n");
      out.write("<label>Start Date: </label><input class=\"form-control\" type=text name=stp' + iCnt+ ' ' + ' id=stp' + iCnt + ' ' +' placeholder=\"\"><br/>\\n\\\n");
      out.write("\\n\\<label>End Date: </label><input class=\"form-control\" type=text name=enp' + iCnt+ ' ' + ' id=enp' + iCnt + ' ' +' placeholder=\"\" autocomplete=\"off\" tabindex=\"1\"><br/>\\n\\\n");
      out.write("<input type=\"button\" class=\"btnP btnReg\" value=\"Remove\">\\n\\<br/><br/></div>'); // end append\n");
      out.write("                          $(\"#anubhi\").show();\n");
      out.write("\t\t\t\t\t$('div .btnP').click (function () { \n");
      ...
      out.write("        }\n");
      out.write("                    });\n");
      out.write("                $('#mainP').after(container);\n");
      out.write("            }\n");
      out.write("            else {   \n");
      out.write("                \n");
      out.write("                $(container).append('<label>Reached the limit! You can add only 8 projects.</label>');  \n");
      out.write("                $('#btPR').attr('disabled', 'disabled');\n");
      out.write("            }\n");
      out.write("        });});\n");
      out.write("</script>\n");
      out.write("\n");
    ...
    try{
        ...
        if(request.getParameter("btn_submit")!=null)
        {
            ...
            while(i!=0)
            {
                ...
                String tit=request.getParameter("pr"+i);
                String start=request.getParameter("stp"+i);
                String end=request.getParameter("enp"+i);
                String des=request.getParameter("pro"+i);
                i++;
                pst.setString(1, nm);
                pst.setString(2, tit);
