...
public final class demo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <div class=\"container-main clearfix\">\n");
      out.write("                <div class=\"rh-logo\">\n");
      out.write("                    ");
      out.write("   \n");
      out.write("                </div>\n");
      out.write("                <nav class=\"navigation float-right\">\n");
      out.write("                    ");
      out.write("\n");
      out.write("     \n");
      out.write("                </nav>\n");
      ...
      out.write("\n");
      out.write("    <button class=\"tablinks\" onclick=\"openCity(event, 'info')\" id=\"defaultOpen\"> <i class=\"material-icons\" style='font-size:36px'>group</i><b>&nbsp;&nbsp;Basic Information</b></button>\n");
      ...
      out.write(" <input type=\"submit\" name=\"btn_submit\" id=\"btn_submit\" value=\"Save all Details\" class=\"button-primary float-right\" />\n");
      out.write("  \n");
      ...
      out.write("                            <div class=\"input-element\">\n");
      out.write("                                <input type=\"text\" name=\"address\" id=\"address\" class=\"error\" placeholder=\"\" maxlength=\"100\" autocomplete=\"off\" tabindex=\"2\">\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"input-row \">\n");
      out.write("                                \n");
      ...
      out.write("      localStorage.setItem('summ', fname.value)\n");
      out.write("    };\n");
      out.write("</script>\n");
      out.write(" <script>\n");
      ...
      out.write("<!--               <script>\n");
      out.write("       //skills\n");
      out.write("     function mySave1() {\n");
      out.write("       var fn = document.getElementById(\"fname\").value;\n");
      out.write("       localStorage.setItem(\"fm\", fn);\n");
      out.write("        var ln = document.getElementById(\"lname\").value;\n");
      out.write("       localStorage.setItem(\"ln\", ln);\n");
      out.write("       var ad = document.getElementById(\"add\").value;\n");
      out.write("       localStorage.setItem(\"ad\", ad);\n");
      out.write("        var ct = document.getElementById(\"city\").value;\n");
      out.write("       localStorage.setItem(\"ct\", ct);\n");
      out.write("        var zp = document.getElementById(\"zip\").value;\n");
      out.write("       localStorage.setItem(\"zp\", zp);\n");
      out.write("       var cn = document.getElementById(\"country\").value;\n");
      out.write("       localStorage.setItem(\"cn\", cn);\n");
      out.write("       var sum = document.getElementById(\"summ\").value;\n");
      out.write("       localStorage.setItem(\"sum\", sum);\n");
      out.write("       var em = document.getElementById(\"email\").value;\n");
      out.write("       localStorage.setItem(\"em\", em);\n");
      out.write("       var ph = document.getElementById(\"contact\").value;\n");
      out.write("       localStorage.setItem(\"ph\", ph);\n");
      out.write("     }\n");
      out.write("     function myLoad1() {\n");
      out.write("       var fn = localStorage.getItem(\"fm\");\n");
      out.write("       document.getElementById(\"fname\").value = fn;\n");
      out.write("       var ln = localStorage.getItem(\"ln\");\n");
      out.write("       document.getElementById(\"lname\").value = ln;\n");
      out.write("       var ad = localStorage.getItem(\"add\");\n");
      out.write("       document.getElementById(\"add\").value = ad;\n");
      out.write("       var ct = localStorage.getItem(\"ct\");\n");
      out.write("       document.getElementById(\"city\").value = ct;\n");
      out.write("       var zp = localStorage.getItem(\"zp\");\n");
      out.write("       document.getElementById(\"zip\").value = zp;\n");
      out.write("       var cn = localStorage.getItem(\"cn\");\n");
      out.write("       document.getElementById(\"country\").value = cn;\n");
      out.write("       var sum = localStorage.getItem(\"sum\");\n");
      out.write("       document.getElementById(\"summ\").value = sum;\n");
      out.write("       var em = localStorage.getItem(\"em\");\n");
      out.write("       document.getElementById(\"email\").value = em;\n");
      out.write("        var ph = localStorage.getItem(\"ph\");\n");
      out.write("       document.getElementById(\"contact\").value = ph;\n");
      out.write("     }\n");
      out.write("   </script>     -->\n");
      out.write(" \n");
      out.write("\n");
      ...
      out.write("                <span style=\"text-align:center;font-size: 10px; color: gray;position:absolute; padding-top: 60px;\">We support JPG, PNG or GIF</span>\n");
      out.write("        \n");
      out.write("        <img src=\"images/u.svg\" style=\"padding-top:80px;\"></img>\n");
      out.write("        <br><br>\n");
      out.write("        \n");
      out.write("        <button class=\"button\">Upload</button>\n");
      out.write("  <br><br>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    \n");
      ...
      out.write("        alert(\"You cannot have more than 8 boxes!\");\n");
      out.write("        return;\n");
      out.write("    }\n");
      out.write("        \n");
      ...
      out.write(" listW.append('<input type=\"submit\" value=remove id=rem' +iCnt+ ' ' + ' name=rem'+iCnt+' class=\"btnP button-primary float-right\" />');\n");
        ...
        }catch(Exception exec) 
    {
      ...
      out.write(" listP.append('<input type=\"submit\" value=remove id=remp' +iCnt+ ' ' + ' name=remp'+iCnt+' class=\"btnP button-primary float-right\" />');\n");
...
//           out.print("<script>alert('W')</script>");
            ...
            while(s!=9)
            {
               ...
               //out.print("<script>alert('All projects saved successfully')</script>"); 
...
//          out.print("<script>alert('1')</script>"); 
          ...
          while(c!=9)
            {
                ...
                // out.print("<script>alert('All certificates saved successfully')</script>"); 
            }
        // out.print("<script>alert('2')</script>"); 
             ...
             while(j!=9)
            {
               ...
               // out.print("<script>alert('All skills saved successfully')</script>"); 
           ...
           // out.print("<script>alert('3')</script>"); 
            ...
            while(k!=9)
            {
               ...
               // out.print("<script>alert('All education saved successfully')</script>"); 
          ...
          //out.print("<script>alert('4')</script>"); 
            ...
            while(q!=9)
            {
              ...
              //out.print("<script>alert('All language saved successfully')</script>"); 
                
            }
               //out.print("<script>alert('5')</script>"); 
                int p=1;
             while(p!=9)
            {
           ...
           out.print("<script>alert('All Details saved successfully')</script>"); 
