...
@WebServlet("/Add_Template_Servlet")
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
             maxFileSize=1024*1024*10,      // 10MB
             maxRequestSize=1024*1024*50)
public class Add_Template_Servlet extends HttpServlet {
private static final String SAVE_DIR="Template";
    ...
    PrintWriter outt = response.getWriter();
        //String savePath = "C:\Users\admin\Documents\NetBeansProjects\WebApplication1" + File.separator + SAVE_DIR; //specify your path here
         ...
         String savePath="";
          String path="F:\\Java Programs\\Banasthali\\web" + File.separator+ SAVE_DIR;
      ...
      try{
        ...
        String query="INSERT INTO TEMPLATE(NAME,FILE) values (?,?)";
           ...
           { outt.println("<script type='text/javascript'> ");
            outt.println("alert('Template uploaded successfully!!')"); 
            outt.println(" window.location.href = 'admin.jsp'");
            outt.println("</script>");
           }
           else
           {
               outt.println("<script type='text/javascript'> ");
            outt.println("alert('Please try again!!')"); 
            outt.println(" window.location.href = 'admin.jsp'");
            outt.println("</script>");
           }
      }
