...
<div class="tab">
    ...
    <button class="tablinks" onclick="openCity(event, 'info')" id="defaultOpen"> <i class="material-icons" style='font-size:36px'>group</i><b>&nbsp;&nbsp;Basic Information</b></button>
 ...
 <input type="submit" name="btn_submit" id="btn_submit" value="Save all Details" class="button-primary float-right" />
        ...
        <div class="form-container-main grid-container content-wrapper">
                    ...
                    <div class="input-row ">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-element">
                                <input type="text" name="add" id="add" class="error" placeholder="" maxlength="100" autocomplete="off" tabindex="2">
                            </div>
                        </div>
                        <div class="input-row ">
...
<input type="button" value="Save" onclick="mySave1()" class="button-primary float-right" name="anubhi" id="anubhi" />
 ...
 <script>
    ...
    <script>
    add.value = localStorage.getItem('add');
    add.oninput = () => {
   ...
   <script>
    ...
    summ.oninput = () => {
      localStorage.setItem('summ', fname.value)
    };
</script>
 <script>
...
<!--               <script>
     ...
     function myLoad1() {
       ...
       document.getElementById("contact").value = ph;
     }
   </script>     -->
    ...
    <div style="border:none; text-align: center;">
        <span style="text-align:center; position:absolute; padding-top: 30px;">Upload your photo</span>
                <span style="text-align:center;font-size: 10px; color: gray;position:absolute; padding-top: 60px;">We support JPG, PNG or GIF</span>
        
        <img src="images/u.svg" style="padding-top:80px;"></img>
        <br><br>
...
<div class="container-main experience-container education-container resume-fn funnel-wrapper">
    ...
    <div id="mainE">
        ...
        <input type="submit" name="btn_submit1" value="Save" onclick="mySavee()" class="button-primary float-right" />
...
addW.click(function(event){
   ...
   if($(".boxw").length >= maximumBoxew){
        alert("You cannot have more than 8 boxes!");
        return;
    }
